    ...
    return (
        <section style={{ marginTop: '3em', fontFamily: 'Climate Crisis', height: '1000px' }}>
            <div className='container row' style={{ display: 'flex', marginTop: '200px', justifyContent: 'center' }}>
                <div id='zoom' style={{ position: "relative", height: "300px", width: '300px', background: 'transparent radial-gradient(closest-side at 50% 50%, #F0EFF6 0%, #000000 100%) 0% 0% no-repeat padding-box', width: '300px', height: '300px', borderRadius: '200px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.5)' }}>
                    ...
                    <Sphere x={25} y={105} z={-1} color='#353535' text='PHP...' onClick={handleSphereClick} hoverColor='#6C7EB7' srcIcon={phpIcon} textColor='#6C7EB7' notHoverColor='transparent radial-gradient(closest-side at 50% 50%, #F0EFF6 0%, #000000 100%) 0% 0% no-repeat padding-box' />
                    <Sphere x={55} y={105} z={-1} color='#FF5722' text='Swift' onClick={handleSphereClick} hoverColor='#FF5722' srcIcon={swiftIcon} textColor='#FF5722' notHoverColor='transparent radial-gradient(closest-side at 50% 50%, #F0EFF6 0%, #000000 100%) 0% 0% no-repeat padding-box' />
                    <Sphere x={85} y={105} z={-1} color='#FF5722' text='TypeScript' onClick={handleSphereClick} hoverColor='#3178C6' srcIcon={typescriptIcon} textColor='#3178C6' notHoverColor='transparent radial-gradient(closest-side at 50% 50%, #F0EFF6 0%, #000000 100%) 0% 0% no-repeat padding-box' />
                ...
                <div id='zoom' style={{ position: "relative", background: 'transparent radial-gradient(closest-side at 50% 50%, #E2BA48 0%, #D49F41 100%) 0% 0% no-repeat padding-box', width: '300px', height: '300px', borderRadius: '200px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.5)' }}>
                    ...
                    <Sphere x={55} y={105} z={-1} color='#0081CB' text='MaterialUI' onClick={handleSphereClick} hoverColor='#0081CB' srcIcon={materialUIIcon} textColor='#0081CB' notHoverColor='transparent radial-gradient(closest-side at 50% 50%, #E2BA48 0%, #F6EAC6 100%) 0% 0% no-repeat padding-box' />
                    <Sphere x={85} y={105} z={-1} color='#0081CB' text='Apollo' onClick={handleSphereClick} hoverColor='#3E1CC1' srcIcon={apolloIcon} textColor='#3E1CC1' notHoverColor='transparent radial-gradient(closest-side at 50% 50%, #E2BA48 0%, #F6EAC6 100%) 0% 0% no-repeat padding-box' />
                ...
                <div id='zoom' style={{ position: "relative", background: 'transparent radial-gradient(closest-side at 50% 50%, #E4E4E4 0%, #469DDC 100%) 0% 0% no-repeat padding-box', width: '300px', height: '300px', borderRadius: '200px', display: 'flex', float: 'right', boxShadow: '0 0 10px rgba(0, 0, 0, 0.5)' }}>
                    ...
                    <Sphere x={25} y={105} z={0} color='#2E64A4' text='JawsDB' onClick={handleSphereClick} hoverColor='#003B6D' srcIcon={jawsDBIcon} textColor='#003B6D' notHoverColor='transparent radial-gradient(closest-side at 50% 50%, #E4E4E4 0%, #469DDC 100%) 0% 0% no-repeat padding-box' />
                    <Sphere x={55} y={105} z={0} color='#2E64A4' text='DynamoDB' onClick={handleSphereClick} hoverColor='#0D416D' srcIcon={dynamoDBIcon} textColor='#0D416D' notHoverColor='transparent radial-gradient(closest-side at 50% 50%, #E4E4E4 0%, #469DDC 100%) 0% 0% no-repeat padding-box' />
                ...
                <div id='zoom' style={{ position: "relative", background: 'transparent radial-gradient(closest-side at 50% 50%, #767676 0%, #E5E5E5 100%) 0% 0% no-repeat padding-box', width: '300px', height: '300px', borderRadius: '200px', display: 'flex', float: 'right', boxShadow: '0 0 10px rgba(0, 0, 0, 0.5)' }}>
                ...
                <div id='zoom' style={{ position: "relative", background: 'transparent radial-gradient(closest-side at 50% 50%, #AAE965 0%, #295819 100%) 0% 0% no-repeat padding-box', width: '300px', height: '300px', borderRadius: '200px', display: 'flex', float: 'left', boxShadow: '0 0 10px rgba(0, 0, 0, 0.5)' }}>
