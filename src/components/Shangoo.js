        ...
        <div id='canvas'>
            ...
            {itemData.map((item) => (
                ...
                <div style={{ fontFamily: 'GravitasOne' }}>
                    ...
                    <a href={item.link} target='_blank'><img src={shangooLogo} style={{ top: '720px', left: '49.4%', width: '75px', position: 'absolute', zIndex: 4, boxShadow: '0px 3px 6px #00000029', borderRadius: '50px', borderColor: '#EFEEF5' }} id='wiggle'></img></a>
