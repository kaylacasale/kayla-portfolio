    ...
    return (
        ...
        >
            <div className="flipper" >
                <div className="front" >
                    <div className='flip-div' style={{ background: 'radial-gradient(circle at 100px 100px, #ffffff, #79CDE6)', borderRadius: '50%', justifyContent: 'center', alignItems: 'center', display: 'flex', boxShadow: '5px 10px 10px rgba(39, 116, 149, 0.5)' }}>
