    ...
    return (
        <div className="carousel-container" id='zoom' style={{ width: '250px', height: '250px', alignItems: 'center' }}>
            ...
            <div style={{ marginTop: '-20px', maxWidth: '100%' }}>
                ...
                <img src={testTumbleLeft} onClick={() => handleClick('prev')} style={{ width: '50px', height: '50px', fontSize: '20px', borderRadius: '100px', boxShadow: '0px 6px 6px #D1F2FF', borderColor: 'white', borderWidth: '.1px', color: 'white', position: 'absolute', left: '5%', top: '180px' }} id='wiggle' className='tumble-btn'></img>
                <img src={testTumbleRight} onClick={() => handleClick('prev')} style={{ width: '50px', height: '50px', fontSize: '20px', borderRadius: '100px', boxShadow: '0px 6px 6px #D1F2FF', borderColor: 'white', borderWidth: '.1px', color: 'white', position: 'absolute', left: '75%', top: '180px' }} id='wiggle' className='tumble-btn'></img>
